(function () {
    ...
    startCompleteButton.addEventListener('click', () => {window.location.href = 'start.html?test=complete'});
    startBasicButton.addEventListener('click', () => {window.location.href = 'start.html?test=basic'});
